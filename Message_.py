...
"""
Message state used by the mix-network simulation.

The ``message`` class stores target probabilities, timing information, and
client metadata for each simulated packet.
"""
