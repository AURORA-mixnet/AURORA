...
"""
Message generation process for the mix-network simulation.

This module creates simulated messages over time and submits them to the
configured mix network.
"""
