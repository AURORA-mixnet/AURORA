...
"""
Mix-node model used by the discrete-event simulation.

The ``Mix`` class models capacity, mixing delay, and target-probability updates
for an individual mix node.
"""
